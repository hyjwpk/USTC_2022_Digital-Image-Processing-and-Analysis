...
变换矩阵为$\begin{bmatrix}
  ...
  -\frac{\sqrt{2} }{2} & \frac{\sqrt{2} }{2} & 0 \\
  0 & 0 & 1
\end{bmatrix}$,利用该矩阵旋转$$(x,y)=(1,0)$$, $$\begin{bmatrix}
 \frac{\sqrt{2} }{2}\\
 -\frac{\sqrt{2} }{2}\\
 1
...
线性失真下校正几何形变的空间变换式为$$\begin{bmatrix}
 x^{'}\\
 y^{'}\\
 1
\end{bmatrix}=\begin{bmatrix}
...
\end{bmatrix}\begin{bmatrix}
 ...
 y\\
 1
\end{bmatrix}$$,其中a1，a2，a3，b1，b2，b3为六个未知参数，根据三角形的三组对应顶点可列出方程$$\begin{bmatrix}
 x_{1} ^{'}\\
 x_{2} ^{'}\\
 x_{3} ^{'}
\end{bmatrix}=\begin{bmatrix}
...
\end{bmatrix}\begin{bmatrix}
 ...
 b_{2}\\
 b_{3}
\end{bmatrix}$$，六个方程六个未知参数即可求解出空间变换式对应的变换矩阵
